<!-- AUTO-GENERADO por scripts/matrix-coverage.sh (v2, knowledge-graph). 2026-07-15 20:13 UTC -->
# Coverage matrix — feature × CONTRATO × substrato (MEASURED, agnóstico)

> Auto-generada el **2026-07-15 20:13 UTC** desde `deploy/knowledge-graph.yaml` cruzado con deps VIVAS +
...
| budget-4layer | LLM | llm-openai-compat, persistence | any | e2e-chaos | ✅ live (5 agente/s gobernado/s) | BudgetExceededError al exceder tokens/USD/tool-calls |
...
| a2a-delegation | Trigger | agent-adapter, persistence | any | e2e-chaos | ✅ live (5 agente/s gobernado/s) | canInvoke permite/deniega; depth+fanout capados; budget = min de 4 |
...
| hardening-mtls | RBAC | cni-netpol-mtls | standalone-cluster | e2e-chaos | ✅ live (5 agente/s gobernado/s) | gateway→CP :8090 solo por mTLS SPIFFE |
...
| shadow-mode | Tools | mcp-transport, persistence | any | e2e-chaos | ✅ live (5 agente/s gobernado/s) | acción interceptada; respuesta opaca; evento shadowed en audit |
| quarantine | Outcome | persistence | any | e2e-chaos | ✅ live (5 agente/s gobernado/s) | thrash → quarantine; auto-release por cooldown |
